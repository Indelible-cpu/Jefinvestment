      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-3xl font-bold text-primary flex items-center gap-2">
            <BarChart3 size={32} /> Reports & End of Day
          </h1>
          <p className="text-gray-500 mt-1">Shift summary, cash reconciliation, and sales breakdown</p>
        </div>
        <div className="flex gap-3 items-center">
          <input type="date" value={reportDate} onChange={e => setReportDate(e.target.value)} className="border rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary outline-none" />
          <button onClick={handlePrint} className="flex items-center gap-2 border px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 font-medium transition">
