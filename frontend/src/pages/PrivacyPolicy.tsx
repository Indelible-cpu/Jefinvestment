      ...
      <div className="max-w-2xl mx-auto p-6 flex-1">
        <div className="bg-white rounded-2xl shadow-sm border p-8 space-y-6 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>JIMS ERP collects only the business information you enter, including sales records, inventory data, expense logs, employee profiles, and customer credit records. No personal browsing data or device information is shared externally.</p>
          </section>

          <section>
            <h3 className="font-bold text-gray-800 mb-2">2. How We Use Your Data</h3>
            <p>All data is used exclusively for operating the JIMS ERP system — generating reports, managing inventory, processing sales, and providing system analytics for Jef Investment. We do not use your data for advertising or profiling.</p>
          </section>
