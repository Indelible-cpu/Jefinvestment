    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-[#004bb4] text-white p-4 flex items-center gap-3 shadow">
        ...
        <div>
          ...
          <p className="text-blue-200 text-xs">JIMS ERP — Indelible Technologies</p>
        </div>
      </div>
      <div className="max-w-2xl mx-auto p-6 flex-1">
        <div className="bg-white rounded-2xl shadow-sm border p-8 space-y-6 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using JIMS ERP, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you may not use this system.</p>
          </section>

          <section>
            <h3 className="font-bold text-gray-800 mb-2">2. Use of the System</h3>
            <p>JIMS ERP is provided exclusively for authorized business use by Jef Investment and its employees. Unauthorized access, sharing of credentials, or misuse of business data is strictly prohibited.</p>
          </section>

          <section>
            <h3 className="font-bold text-gray-800 mb-2">3. Data Ownership</h3>
            <p>All business data entered into JIMS ERP (sales, inventory, expenses, etc.) remains the property of Jef Investment. Indelible Technologies acts as a processor and will never share or sell your business data to third parties.</p>
          </section>

          <section>
            <h3 className="font-bold text-gray-800 mb-2">4. System Availability</h3>
            <p>While we strive for maximum uptime, JIMS ERP operates with offline-first capabilities. Indelible Technologies is not liable for temporary disruptions caused by network outages or scheduled maintenance.</p>
          </section>
      ...
      <div className="text-center text-xs text-gray-400 py-4">JIMS ERP · Powered by Indelible Technologies</div>
    </div>
  );
}
